...
const translations = {
  de: {
    ...
    teaching: {
      ...
      transferImageAlt: "Diagramm zur Reichweite der JuBU pro 1'000 Kinder in der Region von 2010 bis 2024",
      transferImageCaption: "Analyse aus dem Spezialmodul: Reichweite der JuBU pro 1'000 Kinder in der Region, 2010-2024.",
  ...
  en: {
    ...
    teaching: {
      ...
      transferImageAlt: "Chart showing JuBU reach per 1,000 children in the region from 2010 to 2024",
      transferImageCaption: "Analysis from the special module: JuBU reach per 1,000 children in the region, 2010-2024.",
  ...
  fr: {
    ...
    teaching: {
      ...
      transferImageAlt: "Graphique montrant la portée de la JuBU pour 1 000 enfants dans la région de 2010 à 2024",
      transferImageCaption: "Analyse issue du module spécial: portée de la JuBU pour 1 000 enfants dans la région, 2010-2024.",
...
if (t.teaching) {
  ...
  if (specialContact) {
    specialContact.innerHTML = teaching.specialContact + " " +
      `<a class="text-link" href="${SPECIAL_FLYER_LINK}" target="_blank" rel="noreferrer">${teaching.specialFlyer}</a>`;
  }
  ...
  const transferImage = document.querySelector("#lehre .transfer-image img");
  if (transferImage) transferImage.alt = teaching.transferImageAlt;
  setText("#lehre .transfer-image figcaption", teaching.transferImageCaption);
